...
import chefImage from '../assets/CMK_chef.jpg'
import CourseDetails from '../Components/Course components/CourseDetails components/CourseDetails'

const ProfessionalCertificationOfChefs = () => {

  const courseData = [
    {
      courseImg: chefImage,
      imageText: "8320 hours professional certification of chefs",
      classTime: [
        {
          period: "Morning",
          time: "9:00AM - 1:00PM"
...
export default ProfessionalCertificationOfChefs